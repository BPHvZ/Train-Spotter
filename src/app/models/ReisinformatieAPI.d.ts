...
type StationArrivalsResponse = definitions["RepresentationResponseArrivalsPayload"];
type StationArrival = definitions["Arrival"];
type StationArrivalsList = StationArrival[];
