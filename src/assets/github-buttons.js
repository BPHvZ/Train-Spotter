...
!(function () {
	...
	var e = window.document,
		...
		h = function (e, t, o) {
			var r = function () {
				return g(e, t, r), o.apply(this, arguments);
			};
			u(e, t, r);
		},
		f = function (e, t, o) {
			var r = "readystatechange",
				a = function () {
					if (t.test(e.readyState)) return g(e, r, a), o.apply(this, arguments);
				};
			u(e, r, a);
		},
		p = function (e) {
		...
		x = function (e, t) {
			return "@media(prefers-color-scheme:" + e + "){" + k[v(k, t) ? t : e] + "}";
		},
		y = {
			download: {
				heights: {
		...
		C = function (e, t) {
			(e = w(e).replace(/^octicon-/, "")), v(y, e) || (e = "mark-github");
		...
		F = function (e, t) {
			...
			if (!(o.push(t) > 1)) {
				var r = m(function () {
					for (delete z[e]; (t = o.shift()); ) t.apply(null, arguments);
				});
				if (c) {
					var n = new a();
					u(n, "abort", r),
		...
		M = function (e, t, o) {
			var r = p(e.ownerDocument),
				...
				n =
					...
					(function (e) {
						if (null == e) return k.light;
						if (v(k, e)) return k[e];
						var t = s(e, ";", ":", function (e) {
							return e.replace(/^[ \t\n\f\r]+|[ \t\n\f\r]+$/g, "");
						});
						return (
							k[v(k, t["no-preference"]) ? t["no-preference"] : "light"] +
							x("light", t.light) +
							x("dark", t.dark)
						);
					})(t["data-color-scheme"]);
			...
			var i = "large" === w(t["data-size"]),
				c = r(
					"a",
					{
						...
						innerHTML: C(t["data-icon"], i ? 16 : 14),
					},
					[" ", r("span", {}, [t["data-text"] || ""])]
				),
				d = e.appendChild(r("div", { className: "widget" + (i ? " widget-lg" : "") }, [c])),
				u = c.hostname.replace(/\.$/, "");
			if (("." + u).substring(u.length - l.length) !== "." + l) return c.removeAttribute("href"), void o(d);
			var g = (" /" + c.pathname).split(/\/+/);
			if (
				((((u === l || u === "gist." + l) && "archive" === g[3]) ||
					(u === l &&
						"releases" === g[3] &&
						("download" === g[4] || ("latest" === g[4] && "download" === g[5]))) ||
					u === "codeload." + l) &&
					(c.target = "_top"),
				"true" === w(t["data-show-count"]) &&
					u === l &&
					"sponsors" !== g[1] &&
					"orgs" !== g[1] &&
					"users" !== g[1] &&
				...
				var h, f;
				if (!g[2] && g[1]) (f = "followers"), (h = "?tab=followers");
				else if (!g[3] && g[2]) (f = "stargazers_count"), (h = "/stargazers");
				else if (g[4] || "subscription" !== g[3])
					if (g[4] || "fork" !== g[3]) {
						if ("issues" !== g[3]) return void o(d);
						(f = "open_issues_count"), (h = "/issues");
					} else (f = "forks_count"), (h = "/network/members");
				else (f = "subscribers_count"), (h = "/watchers");
				var b = g[2] ? "/repos/" + g[1] + "/" + g[2] : "/users/" + g[1];
		...
		L = function (t, r) {
			if (null != t && null != r)
				if (
					...
					var a = b("span");
					M(a.attachShadow({ mode: "closed" }), t, function () {
						r(a);
					});
				} else {
					var n = b("iframe", {
					...
					var l = function () {
						...
						g(n, "load", l),
							M.call(c, a, t, function (e) {
								var a = (function (e) {
									var t = e.offsetWidth,
										r = e.offsetHeight;
									if (e.getBoundingClientRect) {
										var a = e.getBoundingClientRect();
										(t = o.max(t, E(a.width))), (r = o.max(r, E(a.height)));
									}
									return [t, r];
								})(e);
					...
					u(n, "load", l), e.body.appendChild(n);
				}
		};
	t.protocol + "//" + t.host + t.pathname === i
		? M(e.body, s(window.name || t.hash.replace(/^#/, "")), function () {})
		: (function (t) {
